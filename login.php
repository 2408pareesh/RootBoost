<?php
session_start();
require_once 'db_connection.php'; // Make sure this file defines $pdo
...
<head>
   ...
   * {
    ...
    .cyber-bg {
      ...
      height: 200%;
      width: 200%;
      background: radial-gradient(#0ff2, transparent 60%) center,
                  repeating-linear-gradient(45deg, #0ff1 0 2px, transparent 2px 20px),
                  repeating-linear-gradient(-45deg, #0ff1 0 2px, transparent 2px 20px);
